<template>
    <header class="z-10 py-3 bg-slate-100">
      <div class="container flex justify-between items-center px-6 mx-auto h-full text-indigo-600 md:justify-end">
        <!-- Mobile hamburger -->
